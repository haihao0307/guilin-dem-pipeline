...
const requiredChecks=['allPagesSuccessful','allPageChecks','sourcePairsSame','calibrationComplete','gridComplete','countsBounded','counterexampleTauWithinFivePercent','internalComparisonsFinite','presentationCaptured','outcomeClassified'];
result.status=requiredChecks.every(key=>result.checks[key]===true)?'Candidate-pass':'Candidate-fail';
