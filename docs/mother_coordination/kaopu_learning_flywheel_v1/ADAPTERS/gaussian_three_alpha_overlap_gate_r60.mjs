...
const required=['allPagesSuccessful','allPageChecks','sourcePairsSame','calibrationComplete','gridComplete','countsBounded','tauGroupsWithinFivePercent','internalComparisonsFinite','presentationCaptured','outcomeClassified'];
