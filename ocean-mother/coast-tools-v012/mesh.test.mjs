...
import * as core from '../coast-v012/coast-core.mjs';import * as domain from '../coast-v012/rock-domain.mjs';
const file=new URL('../coast-v012/coast-app.mjs',import.meta.url);
