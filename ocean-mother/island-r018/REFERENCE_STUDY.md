...
## R017 addition
User requested moving light in glass, treeless circular island, three surf bands, additive parameter pages, multiple long smoke and flame strands under adjustable wind. These requests are the source of the R017 design. The previous two linked material pages do not supply a smoke solver or multi-source combustion implementation. The wind-drag particle and kinematic surf algorithms here are independent implementation choices. No exact replication or physically complete combustion is claimed.
