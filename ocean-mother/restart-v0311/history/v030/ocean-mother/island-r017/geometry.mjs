import {TAU,normalize3,bedHeight,DOMAIN,COAST_ROCKS,SURFACE} from './core.mjs';
export function rockGeometry(definitions){
 ...
 for(const [cx,cz,sx,sy,sz,seed] of definitions){
  const base=vertices.length/7,cy=bedHeight(cx,cz)+sy*(.65-SURFACE.rockEmbed),lat=16,lon=32;
