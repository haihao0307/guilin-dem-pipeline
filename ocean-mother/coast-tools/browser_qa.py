...
report={'status':'RUNNING','url':URL,'checks':[],'errors':[],'visualApproved':False,'productionApproved':False,'userHardwarePerformanceVerified':False,'source':'real Chromium browser','performanceScope':'software-rendered paused views; no hardware speed claim'}
