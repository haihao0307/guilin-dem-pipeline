...
async function load(){
  ...
  stats={
    version:'V014',vertices:vertexCount,triangles:indexCount/3,binaryBytes:buffer.byteLength,
...
function buildViews(){
  ...
  views={
    ...
    cliff:{yaw:1.48,pitch:.15,dist:Math.max(520,tallest.renderRelativeHeightM*3.7),target:[p[0],tallest.sourceBaseElevationM+tallest.renderRelativeHeightM*.48,p[1]]},
