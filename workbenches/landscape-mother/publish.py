"""Replace only the authorized workbench subtree after staged checks; never change Pages settings."""
...
for attempt in range(4):
 ...
 commit=api('POST','git/commits',{'tree':tree,'parents':[head],'message':'Publish interactive solid Landscape Mother B3.1 from '+source})['sha']
