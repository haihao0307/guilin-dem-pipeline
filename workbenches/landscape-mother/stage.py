...
names=['index.html','style.css','fields.mjs','checks.mjs','worker.mjs','shaders.mjs','renderer.mjs','app.mjs','manifest.json']
files=[]
for n in names:
...
build={'version':'1.0.0','sourceCommit':a.commit,'coreCommit':'7f5591a56898cd7441a0b95e24025d3a7586376c','files':files,'sourceBytes':sum(f['bytes'] for f in files),'visualApproved':False,'productionReady':False}
