...
void main(){
  ...
  function render() {
    ...
    statusEl.textContent = `V004 · ${desktopHigh ? '4096 级色彩' : '2048 级色彩'} · ${manifest.hydrology.clippedWaterwayFeatures.toLocaleString('zh-CN')} 条 OSM 水路线 · ${manifest.hydrology.clippedWaterAreaFeatures.toLocaleString('zh-CN')} 个水体面 · 镜头离地约 ${clearance.toFixed(clearance < 100 ? 1 : 0)} m`;
