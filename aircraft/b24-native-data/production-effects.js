...
export function install(api){
 ...
 const state={enabled:true,ready:true,weather:false,fog:false,visualAcceptance:false,
  acceptedBaseline:'V017',candidate:'V018',warnings,bladeInstances:blur.length*SAMPLES,
 ...
 api.productionEffects=state;api.build='B24_V018_COMPACT_DATA';api.visualAcceptance=false;api.acceptedBaseline={version:'V017',visualAcceptance:true,sourceCommit:'ceed8183dc5fb8399349e73ebeef5b997d7d7389'};
 api.compactData={sourceImages:0,sourceUV:0,dataBytes:4061477,previousDataBytes:8917196,geometryMode:'exact-numeric-transition',parametricComplete:false,motion:plane.motion.summary()};
 const box=document.createElement('section');box.id='r2Controls';box.innerHTML='<div class="sectionTitle"><h3>本轮效果对照</h3><span>V018 待确认</span></div><label class="toggle"><span>轮胎旧化、金属细节与残影</span><input id="r2Enabled" type="checkbox" checked></label><p class="hint">飞机数据 4.06 MB，较上一版减少 54.5%。已移除原图片与 UV；整机曲面规则化仍在进行。关闭可比较原材质与显示效果。天气和雾暂不接入。滚转与残影属于展示近似。</p>';
 ...
 const footer=document.querySelector('#panel footer');if(footer)footer.textContent='V017 已确认保留 · V018 效果候选 · 天气与雾未接入';
