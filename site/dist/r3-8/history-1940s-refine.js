...
function refineMask(terrain,box){
  ...
  return{texture,data:smooth,width:w,height:h,xuanmenOpened,islandRestored,highGroundSeeds:seeds,landGrowthClamped};
}
