...
export const snapshot={...R74.snapshot,version:VERSION,visualAcceptance:false,browserQA:false,productionReady:false,parcelGenerationEnabled:false,waterStateKnown:false,round77:{
 ...
 logicCorrection:'It would be wrong for R77 to infer a predecessor-relative budget by subtracting nominal absolute caps. The latest R76 candidate already separated a 0.035 m profile cap from a 0.037 m safety budget, but some R76 danger endpoints used less than that nominal 0.037 m. Run 2 therefore produced a 0.010 m R76-relative move even though 0.045-0.037=0.008. R77 now caps the delta from the actual R76 state directly at 0.008 m. Calm R76 geometry remains bit-for-bit unchanged; only already-identified high 3 m relations may consume the extra bounded safety budget. The unchanged 1.05 m cliff gate and stronger 1.030 m proof bound remain, and passing them still does not imply whole-slope visual acceptance.',
