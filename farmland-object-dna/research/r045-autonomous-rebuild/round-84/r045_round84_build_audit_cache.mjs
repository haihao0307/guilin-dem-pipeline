...
// Fixed-view evidence needs the actual candidate surface, but the audit raster is
// intentionally bounded: 41x25 samples are enough to show hillside-scale contour
// rhythm at the fixed camera and avoid pretending that denser rendering adds truth.
