  ...
  <pipe>
    <rasterrenderer opacity="1" alphaBand="0" band="1" type="paletted">
      ...
      <colorPalette>
        ...
        <paletteEntry value="1" color="#0000dd" label="Permanent"/>
        <paletteEntry value="2" color="#22b14c" label="New permanent"/>
        <paletteEntry value="3" color="#d12d3e" label="Lost permanent"/>
        <paletteEntry value="4" color="#99d9ea" label="Seasonal"/>
        <paletteEntry value="5" color="#b5e61d" label="New seasonal"/>
        <paletteEntry value="6" color="#e6a1aa" label="Lost seasonal"/>
        <paletteEntry value="7" color="#ff7f27" label="Seasonal to permanent"/>
        <paletteEntry value="8" color="#ffc90e" label="Permanent to seasonal"/>
        <paletteEntry value="9" color="#7f7f7f" label="Ephemeral permanent"/>
        <paletteEntry value="10" color="#c3c3c3" label="Ephemeral seasonal"/>
        ...
        <paletteEntry value="255" color="#d2d2d2" label="No data"/>
      </colorPalette>
    </rasterrenderer>
