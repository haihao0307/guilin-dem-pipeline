...
void main(){
  ...
  float directVisibility=mix(1.0,.26,castShadow*.82);
...
async function load(){
  ...
  stats={
    version:'V015P1',vertices:vertexCount,triangles:indexCount/3,binaryBytes:buffer.byteLength,
...
function buildViews(){
  ...
  views={
    ...
    cliff:{yaw:1.48,pitch:.10,dist:Math.max(430,tallest.renderRelativeHeightM*3.1),target:[p[0],tallest.sourceBaseElevationM+tallest.renderRelativeHeightM*.48,p[1]]},
