...
const partUrls = Array.from({ length: 40 }, (_, index) => `./app.part${index + 1}.js?v=3700`);
if (!partUrls.at(-1)?.endsWith('app.part40.js?v=3700')) throw new Error('Landscape Mother 字段核心尾分片合同缺失');
