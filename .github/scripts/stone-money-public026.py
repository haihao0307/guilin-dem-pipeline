"""Verify exact immutable public Stone Money Island V0.2.6 bytes and browser entry."""
...
OUT=Path('games/survivor-palau/releases/v0.2.6');SHOTS=Path('/tmp/smi-public026');SHOTS.mkdir(exist_ok=True)
proof={'version':'0.2.6','url':URL,'entrySha256':EXPECTED,'sourceCommit':os.environ['SMI_SOURCE_COMMIT'],'pagesCommit':os.environ['SMI_PAGES_COMMIT'],'publicHttpsPassed':False,'browserPassed':False,'shareAllowed':False,'visualAcceptance':False,'physicalDeviceTest':False,'cases':[]}
def save():
