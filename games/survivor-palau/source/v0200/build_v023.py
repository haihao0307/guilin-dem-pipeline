...
a=re.search(pattern,base.read_text(),re.S);b=re.search(pattern,s,re.S)
assert a and b and a.group(1)==b.group(1)

OUT=HERE.parents[1]/'releases/v0.2.3'
...
receipt={
 'version':'0.2.3',
 'sourceBranch':'work/stone-money-island-v0230-arch-flyview-20260920',
 'baseCommit':'fac8e6c8d1bcc585ab76547822ff07689f55377b',
 ...
 'candidateBeach':{
  'radius':92,'beachWidth':50,'shelfWidth':84,
  'nominalAreaRatioVsOriginal':new_area/old_area,
  'regime':'reef-protected lagoon','surveyed':False
 },
 'physicalWaterGate':'dynamic surface is capped by local run-up ceiling and fragments require positive clearance above the same bed query',
 'stoneMoney':{'x':112,'z':23,'support':'compiled Rock Island height query'},
 'archCandidate':{'center':[184.5,-70],'openVoid':True,'source':'authored game candidate; not a surveyed Palau arch'},
 'distantRockIslandBodies':14,
 'deepTrench':{'probe':[-168,-132],'additionalDepthM':34,'surveyed':False},
 'aerialReview':True,
 'fishIntegration':{
  'sourceCommit':'11970757e0233f31446ed399257de1dd4bdf1c00',
  'sourcePath':'apps/ocean-life-mother/r02/runtime-r02.js',
  'method':'nine fixed-length body sections with periodic carrier phase',
  'speciesAccepted':False
 },
 ...
 'gameplay':['on-foot first person','fixed aerial review view','wooden spear craft and source-coupled segmented fish motion','coconut use','inventory object transitions','natural shelter rest and day counter','patrol LOS candidate and failure','local save','damaged radio inspection only']
}
