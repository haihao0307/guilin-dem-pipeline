...
def apply(s: str) -> str:
    ...
    rep("inMain(u)?archCurve(u,mainL,mainR,10.7,.58,.18)",
        "inMain(u)?archCurve(u,mainL,mainR,12.2,.56,.20)")
    ...
    rep("cameraMode,archGeometry:'dissolved-mushroom-rock-island-v027',archOpening:{nominalMainSpan:18.6,height:19.5,tidalUndercut:true,asymmetric:true,offCenter:true,secondarySeaCave:true},archMass:{tidalToCrownWidthRatio:.46,vegetationPockets:7,unequalCrownLobes:true,minimumRoofThickness:5.7},archCrown:'irregular-pocket-vegetation-same-geometry-build',source:",
        "cameraMode,archGeometry:'dissolved-mushroom-rock-island-v028-revealed',archPosition:[210,190],archOpening:{nominalMainSpan:23.94,height:21.0,tidalUndercut:true,asymmetric:true,offCenter:true,secondarySeaCave:true},archMass:{tidalToCrownWidthRatio:.46,vegetationPockets:7,unequalCrownLobes:true,minimumRoofThickness:4.8},archCrown:'irregular-pocket-vegetation-same-geometry-build',source:")
