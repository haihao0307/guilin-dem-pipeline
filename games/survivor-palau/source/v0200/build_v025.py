...
receipt={
 ...
 'archLandmark':{'geometry':'continuous irregular eroded limestone ridge with true negative-space opening','outerSpanM':58,'openingSpanM':29,'outerRiseM':18,'openingRiseAboveSpringM':10.8,'openingHeightAboveTidalBaseM':21.8,'tidalSupportHeightM':11,'tidalUndercut':True,'frontBackDepthM':15,'sourceMorphology':'Palau limestone Rock Islands: weathered mushroom/undercut family; exact proportions remain authored candidate, not survey'},
 'archReferenceBoundary':['UNESCO Rock Islands Southern Lagoon: limestone islands shaped by weather/wind/vegetation and commonly mushroom-like','Palau sea-arch photographs used only as morphology reference; no mesh or texture copied'],
